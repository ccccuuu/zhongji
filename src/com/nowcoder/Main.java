...
public class Main {
    ...
    public static void demoString(){
        ...
        print(5,str.compareTo("helloz"));
        print(6,str.compareToIgnoreCase("HelloCCC"));
        print(7,str.concat("!!"));
        print(8,str.contains("hello"));
        print(9,str.endsWith("ccc"));
        print(10,str.startsWith("hello"));
        print(11,str.lastIndexOf('c'));
        print(12,str.toUpperCase());
        print(13,str.replace('o','a'));
        print(14,str.replaceAll("o|c","a"));
    ...
    public static void demoList(){
        ...
        print(2,strList);
        strList.remove(0);//删除0位置
        print(3,strList);
        strList.remove(String.valueOf(1));//删除第一次出现的字符串“1”
        print(4,strList);
    ...
    public  static void demoException(){
        try {
             print(1,"hello");
             int a = 2;
             a = a/0; //不属于 NullPointerException  跳到Exception
             String b = null;
             b.indexOf('a');
